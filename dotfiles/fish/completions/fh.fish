...
complete -c fh -n "__fish_fh_needs_command" -l logger -d 'Which logger to use' -r -f -a "compact\t''
full\t''
pretty\t''
json\t''"
...
complete -c fh -n "__fish_fh_needs_command" -f -a "fetch" -d 'Fetch a flake output and write a symlink for the Nix store path to the target link'
...
complete -c fh -n "__fish_fh_using_subcommand add" -l logger -d 'Which logger to use' -r -f -a "compact\t''
full\t''
pretty\t''
json\t''"
...
complete -c fh -n "__fish_fh_using_subcommand apply; and not __fish_seen_subcommand_from home-manager nix-darwin nixos help" -l use-scoped-token -d 'By default, fh apply exchanges its API token for a tightly scoped token generated by FlakeHub that _only_ allows substituting the given output. Pass --use-scoped-token=never to use the system\'s FlakeHub token, and not perform exchanging for a tightly scoped token' -r -f -a "always\t''
never\t''"
...
complete -c fh -n "__fish_fh_using_subcommand apply; and not __fish_seen_subcommand_from home-manager nix-darwin nixos help" -l logger -d 'Which logger to use' -r -f -a "compact\t''
full\t''
pretty\t''
json\t''"
...
complete -c fh -n "__fish_fh_using_subcommand apply; and __fish_seen_subcommand_from home-manager" -l logger -d 'Which logger to use' -r -f -a "compact\t''
full\t''
pretty\t''
json\t''"
...
complete -c fh -n "__fish_fh_using_subcommand apply; and __fish_seen_subcommand_from nix-darwin" -l logger -d 'Which logger to use' -r -f -a "compact\t''
full\t''
pretty\t''
json\t''"
...
complete -c fh -n "__fish_fh_using_subcommand apply; and __fish_seen_subcommand_from nixos" -l logger -d 'Which logger to use' -r -f -a "compact\t''
full\t''
pretty\t''
json\t''"
...
complete -c fh -n "__fish_fh_using_subcommand completion" -l logger -d 'Which logger to use' -r -f -a "compact\t''
full\t''
pretty\t''
json\t''"
...
complete -c fh -n "__fish_fh_using_subcommand convert" -l logger -d 'Which logger to use' -r -f -a "compact\t''
full\t''
pretty\t''
json\t''"
...
complete -c fh -n "__fish_fh_using_subcommand eject" -l logger -d 'Which logger to use' -r -f -a "compact\t''
full\t''
pretty\t''
json\t''"
...
complete -c fh -n "__fish_fh_using_subcommand fetch" -l api-addr -d 'The FlakeHub address to communicate with' -r
complete -c fh -n "__fish_fh_using_subcommand fetch" -l cache-addr -d 'The FlakeHub cache to communicate with' -r
complete -c fh -n "__fish_fh_using_subcommand fetch" -l frontend-addr -d 'The FlakeHub frontend address to communicate with' -r
complete -c fh -n "__fish_fh_using_subcommand fetch" -l logger -d 'Which logger to use' -r -f -a "compact\t''
full\t''
pretty\t''
json\t''"
complete -c fh -n "__fish_fh_using_subcommand fetch" -l log-directive -d 'Tracing directives' -r
complete -c fh -n "__fish_fh_using_subcommand fetch" -s v -l verbose -d 'Enable debug logs, -vv for trace'
complete -c fh -n "__fish_fh_using_subcommand fetch" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c fh -n "__fish_fh_using_subcommand init" -l logger -d 'Which logger to use' -r -f -a "compact\t''
full\t''
pretty\t''
json\t''"
...
complete -c fh -n "__fish_fh_using_subcommand list; and not __fish_seen_subcommand_from flakes label orgs releases versions help" -l logger -d 'Which logger to use' -r -f -a "compact\t''
full\t''
pretty\t''
json\t''"
...
complete -c fh -n "__fish_fh_using_subcommand list; and __fish_seen_subcommand_from flakes" -l owner -d 'List flakes owned by this FlakeHub account. Includes private flakes your account has access to' -r
complete -c fh -n "__fish_fh_using_subcommand list; and __fish_seen_subcommand_from flakes" -s l -l limit -d 'Maximum number of results' -r
...
complete -c fh -n "__fish_fh_using_subcommand list; and __fish_seen_subcommand_from flakes" -l logger -d 'Which logger to use' -r -f -a "compact\t''
full\t''
pretty\t''
json\t''"
...
complete -c fh -n "__fish_fh_using_subcommand list; and __fish_seen_subcommand_from label" -s l -l limit -d 'Maximum number of results' -r
...
complete -c fh -n "__fish_fh_using_subcommand list; and __fish_seen_subcommand_from label" -l logger -d 'Which logger to use' -r -f -a "compact\t''
full\t''
pretty\t''
json\t''"
...
complete -c fh -n "__fish_fh_using_subcommand list; and __fish_seen_subcommand_from orgs" -s l -l limit -d 'Maximum number of results' -r
...
complete -c fh -n "__fish_fh_using_subcommand list; and __fish_seen_subcommand_from orgs" -l logger -d 'Which logger to use' -r -f -a "compact\t''
full\t''
pretty\t''
json\t''"
...
complete -c fh -n "__fish_fh_using_subcommand list; and __fish_seen_subcommand_from releases" -s l -l limit -d 'Maximum number of results' -r
...
complete -c fh -n "__fish_fh_using_subcommand list; and __fish_seen_subcommand_from releases" -l logger -d 'Which logger to use' -r -f -a "compact\t''
full\t''
pretty\t''
json\t''"
...
complete -c fh -n "__fish_fh_using_subcommand list; and __fish_seen_subcommand_from versions" -s l -l limit -d 'Maximum number of results' -r
...
complete -c fh -n "__fish_fh_using_subcommand list; and __fish_seen_subcommand_from versions" -l logger -d 'Which logger to use' -r -f -a "compact\t''
full\t''
pretty\t''
json\t''"
...
complete -c fh -n "__fish_fh_using_subcommand login" -l logger -d 'Which logger to use' -r -f -a "compact\t''
full\t''
pretty\t''
json\t''"
...
complete -c fh -n "__fish_fh_using_subcommand resolve" -l logger -d 'Which logger to use' -r -f -a "compact\t''
full\t''
pretty\t''
json\t''"
...
complete -c fh -n "__fish_fh_using_subcommand search" -s l -l limit -d 'Maximum number of results' -r
...
complete -c fh -n "__fish_fh_using_subcommand search" -l logger -d 'Which logger to use' -r -f -a "compact\t''
full\t''
pretty\t''
json\t''"
...
complete -c fh -n "__fish_fh_using_subcommand status" -l logger -d 'Which logger to use' -r -f -a "compact\t''
full\t''
pretty\t''
json\t''"
...
complete -c fh -n "__fish_fh_using_subcommand help; and not __fish_seen_subcommand_from add apply completion convert eject fetch init list login resolve search status help" -f -a "add" -d 'Adds a flake input to your flake.nix'
complete -c fh -n "__fish_fh_using_subcommand help; and not __fish_seen_subcommand_from add apply completion convert eject fetch init list login resolve search status help" -f -a "apply" -d 'Apply the configuration at the specified FlakeHub output reference to the current system'
complete -c fh -n "__fish_fh_using_subcommand help; and not __fish_seen_subcommand_from add apply completion convert eject fetch init list login resolve search status help" -f -a "completion" -d 'Prints completion for shells to use'
complete -c fh -n "__fish_fh_using_subcommand help; and not __fish_seen_subcommand_from add apply completion convert eject fetch init list login resolve search status help" -f -a "convert" -d 'Convert flake inputs to FlakeHub when possible'
complete -c fh -n "__fish_fh_using_subcommand help; and not __fish_seen_subcommand_from add apply completion convert eject fetch init list login resolve search status help" -f -a "eject" -d 'Convert flake inputs from FlakeHub back to GitHub'
complete -c fh -n "__fish_fh_using_subcommand help; and not __fish_seen_subcommand_from add apply completion convert eject fetch init list login resolve search status help" -f -a "fetch" -d 'Fetch a flake output and write a symlink for the Nix store path to the target link'
complete -c fh -n "__fish_fh_using_subcommand help; and not __fish_seen_subcommand_from add apply completion convert eject fetch init list login resolve search status help" -f -a "init" -d 'Create a new flake.nix using an opinionated interactive initializer'
complete -c fh -n "__fish_fh_using_subcommand help; and not __fish_seen_subcommand_from add apply completion convert eject fetch init list login resolve search status help" -f -a "list" -d 'Lists key FlakeHub resources'
complete -c fh -n "__fish_fh_using_subcommand help; and not __fish_seen_subcommand_from add apply completion convert eject fetch init list login resolve search status help" -f -a "login" -d 'Log in to FlakeHub in order to allow authenticated fetching of flakes'
complete -c fh -n "__fish_fh_using_subcommand help; and not __fish_seen_subcommand_from add apply completion convert eject fetch init list login resolve search status help" -f -a "resolve" -d 'Resolves a FlakeHub flake reference into a store path'
complete -c fh -n "__fish_fh_using_subcommand help; and not __fish_seen_subcommand_from add apply completion convert eject fetch init list login resolve search status help" -f -a "search" -d 'Searches FlakeHub for flakes that match your query'
complete -c fh -n "__fish_fh_using_subcommand help; and not __fish_seen_subcommand_from add apply completion convert eject fetch init list login resolve search status help" -f -a "status" -d 'Check your FlakeHub token status'
complete -c fh -n "__fish_fh_using_subcommand help; and not __fish_seen_subcommand_from add apply completion convert eject fetch init list login resolve search status help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
